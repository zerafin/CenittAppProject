...
public class TarifaBasica extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tarifa_basica);
        setTitle(getString(R.string.Tarifa01_dac_02));
